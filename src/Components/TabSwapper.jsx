...
const TabSwapper = ({ active, selectTab, children, disabled }) => {
    ...
    return (
        <button onClick={selectTab} disabled={disabled} className={`mr-3 font-semibold hover:text-white ${buttonClasses}`}>
            <motion.div
